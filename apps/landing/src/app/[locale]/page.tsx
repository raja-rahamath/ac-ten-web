        ...
        <div className="container mx-auto px-4 py-4">
          <nav className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link href={`${process.env.NEXT_PUBLIC_PORTAL_URL}/login`} className="hidden sm:inline-flex items-center justify-center whitespace-nowrap font-medium transition-colors border border-input bg-background shadow-sm hover:bg-accent hover:text-accent-foreground h-8 rounded-md px-3 text-xs">
                Sign In
              </Link>
              <Link href={`${process.env.NEXT_PUBLIC_PORTAL_URL}/services`} className="inline-flex items-center justify-center whitespace-nowrap font-medium bg-gradient-to-r from-primary to-purple-600 text-white hover:opacity-90 transition-opacity h-8 rounded-md px-3 text-xs">
                Browse Services
              </Link>
            </div>
          </nav>
      ...
      <section className="container mx-auto px-4 py-24 text-center">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="flex flex-col justify-center gap-4 sm:flex-row">
            <Link href={`${process.env.NEXT_PUBLIC_PORTAL_URL}/services`} className="inline-flex items-center justify-center whitespace-nowrap text-sm font-medium bg-gradient-to-r from-primary to-purple-600 text-white hover:opacity-90 transition-all shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 h-11 rounded-md px-8 gap-2">
              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
              </svg>
              Browse Services
            </Link>
            <Link href={`${process.env.NEXT_PUBLIC_PORTAL_URL}/login`} className="inline-flex items-center justify-center whitespace-nowrap text-sm font-medium transition-colors border border-border/60 bg-background/50 backdrop-blur-sm hover:bg-muted h-11 rounded-md px-8 gap-2">
              Sign In
            </Link>
          </div>
        </div>
