...
export default function NewEmployeePage() {
  ...
  useEffect(() => {
    ...
    setDesignations([
      { id: 'desig-1', name: 'Technician' },
      { id: 'desig-2', name: 'Senior Technician' },
      { id: 'desig-3', name: 'Manager' },
    ]);
  }, []);
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const response = await fetch('http://localhost:4001/api/v1/employees', {
        method: 'POST',
        headers: {
    ...
    <div className="mx-auto max-w-2xl">
      ...
      <div className="rounded-xl bg-white p-8 shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              <label htmlFor="departmentId" className="mb-2 block font-medium">
                Department
              </label>
              <select
                id="departmentId"
            ...
            <div>
              <label htmlFor="designationId" className="mb-2 block font-medium">
                Designation
              </label>
              <select
                id="designationId"
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              <label htmlFor="dateOfJoining" className="mb-2 block font-medium">
                Date of Joining
              </label>
              <input
                id="dateOfJoining"
